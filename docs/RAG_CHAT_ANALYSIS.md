...
- **Faz 4:** 4.1 TTS ✅ (Faz 3'te) · 4.2 regenerate ✅ (Faz 3'te) · 4.3 export ✅ · 4.4 STT ✅ · 4.5 multi-doc chat ✅ (iOS LibraryChatView + web persist; chats.file_id NULL satırlar, cross-file RPC'ler prod'da) · 4.6 chat arama ✅ · 4.8 composer görsel ✅ · **Kalan:** 4.7 web deep-search toggle + dinamik öneriler, 4.9 formül desteği (uzun vade), 2.7 normal aramada rerank (bilinçli kapalı).
