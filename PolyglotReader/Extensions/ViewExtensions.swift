...
struct ThemeColors {
    ...
    // Highlight Colors (with safe fallback)
    let highlightYellow = Color(hex: "#fef08a") ?? Color.yellow
    let highlightGreen = Color(hex: "#bbf7d0") ?? Color.green
    let highlightPink = Color(hex: "#fbcfe8") ?? Color.pink
    let highlightBlue = Color(hex: "#bae6fd") ?? Color.blue
}
