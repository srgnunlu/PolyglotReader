...
struct Folder: Codable, Identifiable, Hashable {
    ...
    init(id: UUID = UUID(), name: String, color: String = "#6366F1", parentId: UUID? = nil, userId: String, createdAt: Date = Date(), fileCount: Int = 0) {
        self.id = id
        self.name = name
        self.color = color
...
struct Tag: Codable, Identifiable, Hashable {
    ...
    init(id: UUID = UUID(), name: String, color: String = "#22C55E", userId: String, createdAt: Date = Date(), fileCount: Int = 0, isAutoGenerated: Bool = true) {
        self.id = id
        self.name = name
        self.color = color
        self.userId = userId
...
struct PDFDocumentMetadata: Codable, Identifiable {
    ...
    init(id: String, name: String, size: Int, uploadedAt: Date, storagePath: String, thumbnailData: Data? = nil, summary: String? = nil, folderId: UUID? = nil, tags: [Tag] = [], aiCategory: String? = nil) {
        self.id = id
        self.name = name
        self.size = size
...
extension Annotation {
    ...
    var safeForJSON: Annotation {
        ...
        return Annotation(
            ...
            type: decoded.type,
            color: safeString(decoded.color, fallback: "#fef08a").isEmpty ? "#fef08a" : safeString(decoded.color, fallback: "#fef08a"),
            rects: decoded.rects,
